...
function VisulasSection() {
  return (
    <section class="visual-main-wrapper">
      <div class="visual-second-main-wrapper">
        <h2 class="visual-text-main-wrapper">
        ...
        <div class="visual-links-wrapper">
          <a
            class="visual-links-wrapper-main"
            href="/cleanup"
          >
            <div
              class="visual-video-wrapper-main"
              style={{height: '13rem'}}
            >
              <video class="visual-video-tag-" loop="" playsinline="">
                <source
            ...
            <div class="position-absolute bottom-4 w-100 d-flex justify-content-center">
              <div
                class="rounded-circle overflow-hidden whitespace-nowrap d-flex justify-content-center shadow-md"
                style={{width: '0px'}}
              >
                <div class="bg-primary-100">
                  <div
                    class="visualsection-cards-heading "
                   style={{opacity:0}}
                  >
                    <font style={{verticalAlign: 'inherit'}}>
            ...
            <div class="visualssection-main-card-wrapper ">
              <div class="visualssection-second-card-wrapper">
                <svg
                  width="1.5rem"
                  height="1.5rem"
                  viewBox="0 0 50 50"
              ...
              <p class="line-clamp-2 visualssection-description-card-wrapper">
                Enlevez des objets, personnes, textes ou défauts de vos images
                automatiquement.
              </p>
            </div>
          </a>
          ...
          >
            ...
            <div class="visualssection-main-card-wrapper ">
              <div class="visualssection-second-card-wrapper">
                ...
                <div class="line-clamp-1">Remove background</div>
              </div>
              <p class="line-clamp-2 visualssection-description-card-wrapper">
                Détourez le sujet principal de vos photos avec une qualité
                incroyable.
              </p>
            </div>
          </a>
          ...
          >
            ...
            <div class="visualssection-main-card-wrapper ">
              <div class="visualssection-second-card-wrapper">
                ...
                <div class="line-clamp-1">Relight</div>
              </div>
              <p class="line-clamp-2 visualssection-description-card-wrapper">
          ...
          >
            ...
            <div class="visualssection-main-card-wrapper ">
              <div class="visualssection-second-card-wrapper">
                ...
                <div class="line-clamp-1">Stable Diffusion</div>
              </div>
              <p class="line-clamp-2 visualssection-description-card-wrapper">
          ...
          >
            ...
            <div class="visualssection-main-card-wrapper ">
              <div class="visualssection-second-card-wrapper">
                ...
                <div class="line-clamp-1">Replace background</div>
              </div>
              <p class="line-clamp-2 visualssection-description-card-wrapper">
          ...
          >
            ...
            <div class="visualssection-main-card-wrapper ">
              <div class="visualssection-second-card-wrapper">
                ...
                <div class="line-clamp-1">Text remover</div>
              </div>
              <p class="line-clamp-2 visualssection-description-card-wrapper">
          ...
          >
            ...
            <div class="visualssection-main-card-wrapper">
              <div class="visualssection-second-card-wrapper">
                ...
                <div class="line-clamp-1">SD Reimagine</div>
              </div>
              <p class="line-clamp-2 visualssection-description-card-wrapper">
